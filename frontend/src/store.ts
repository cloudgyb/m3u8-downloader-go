...
import { fmtDuration, nowStr, deriveName } from './utils'
import { DEFAULT_SETTINGS } from './types'
import type { Settings, Task, HistoryItem, TaskStatus, Theme, Lang, View, HistFilter } from './types'
...
const DEMO_HISTORY: Array<Omit<HistoryItem, 'id'>> = [
  { name: '蓝色星球 · 第二季 E01.mkv', url: 'https://demo.cdn.example/blue-planet-s2e1.m3u8', size: 1331 * 1024 * 1024, status: 'completed', finishedAt: '2026-09-19 14:30', duration: '12:34', error: '', file: '' },
  { name: '数据结构 · 第 3 讲.mp4', url: 'https://demo.cdn.example/ds03.m3u8', size: 0, status: 'failed', finishedAt: '2026-09-18 09:15', duration: '00:42', error: 'err.timeout', file: '' },
  { name: '国风音乐会 · 2023 跨年.mkv', url: 'https://demo.cdn.example/concert.m3u8', size: 843 * 1024 * 1024, status: 'completed', finishedAt: '2026-09-15 21:02', duration: '08:11', error: '', file: '' },
]
